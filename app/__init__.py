...
def create_app():
    ...
    # ruta a centros
    app.add_url_rule('/centros', 'centros', centros_de_ayuda.filtrar_centros, methods=["GET"])
    app.add_url_rule('/centros/page/<int:page>', 'centros', centros_de_ayuda.filtrar_centros, methods=["GET"])
