...
def create_app():
    ...
    app.add_url_rule('/centros', 'centros',
                     centros_de_ayuda.filtrar_centros, methods=["GET"])
    app.add_url_rule('/centros/page/<int:page>', 'centros',
                     centros_de_ayuda.filtrar_centros, methods=["GET"])
    app.add_url_rule('/centros', 'filtrar_centros',
                     centros_de_ayuda.filtrar_centros, methods=["POST", "GET"])
    app.add_url_rule('/centros/page/<int:page>', 'filtrar_centros',
                     centros_de_ayuda.filtrar_centros, methods=["POST", "GET"])
